...
class NormalizeStrings(Base):
    ...
    def export() -> None:
        ...
        onnx.save(model, f'{MODEL}_model_monday_casesensintive_nochangecase.onnx')
        ...
        onnx.save(model, f'{MODEL}_strnorm_model_nostopwords_nochangecase.onnx')
        ...
        onnx.save(model, f'{MODEL}_strnorm_model_monday_casesensintive_lower.onnx')
        ...
        onnx.save(model, f'{MODEL}_strnorm_model_monday_casesensintive_upper.onnx')
        ...
        onnx.save(model, f'{MODEL}_strnorm_model_monday_insensintive_upper_twodim.onnx')
        ...
        onnx.save(model, f'{MODEL}_strnorm_model_monday_empty_output.onnx')


model = NormalizeStrings()
model.export()