...
OWNER = "run_quantized_reshape_cleanup"
RESULT_TARGET = "_layout_pass_set_1_quantized_reshape_stats"
...
def test_quantized_reshape_result_schema_and_all_selections_are_explicit() -> None:
    assert run_quantized_reshape_cleanup(
        ModelIR("quantized_reshape_result_schema")
    ) == {"folded_dequant_reshape_quantize_chains": 0}
