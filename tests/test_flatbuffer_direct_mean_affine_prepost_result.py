...
OWNER = "_optimize_transpose_mean_mul_add_const_prepost_nhwc_chains"
NESTED_OWNER = "optimize_transpose_mean_mul_add_const_prepost_nhwc_chains"
RESULT_TARGET = "_layout_pass_set_1_mean_affine_prepost_stats"
...
def test_mean_affine_prepost_schema_and_selections_are_explicit() -> None:
    assert optimize_transpose_mean_mul_add_const_prepost_nhwc_chains(
        ModelIR("mean_affine_prepost_result_schema")
    ) == {"optimized_transpose_mean_mul_add_const_prepost_nhwc_chains": 0}
