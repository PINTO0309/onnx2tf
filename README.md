...
2. In the following example, the `max_output_boxes_per_class` of NMS in the post-processing generated by YOLOv7 is changed from `-Inifinte` to `20`, as shown in the figure below.
